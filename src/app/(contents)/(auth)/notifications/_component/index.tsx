import { NotificationListRenderer } from "@/app/(contents)/(auth)/notifications/_component/NotificationListRenderer";
import {
...
export const NotificationContainer = async (props: Props) => {
  ...
  const [notifications, count] = await findNotificationsAndCount(
    user.id,
    props,
  );
